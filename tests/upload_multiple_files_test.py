...
FILE1 = os.path.join(BASE_DIR, 'Rack_and_Pinion.STEP')
FILE2 = os.path.join(BASE_DIR, 'lower_right.SLDPRT')
...
class TestUploadFile():
    ...
    def test_upload_multiple_files(self):
        """
        Performs file upload test for multiple files.
        """
        try:
            # Files list
            ...
            # Upload a first file in the list
            upload_file_page.click_upload_file(files_list)

            # Upload additional files
            upload_file_page.click_add_additional_files(files_list)
